...
const API_KEY = "34cced80432f27f27a0c3a8929f58966";  
const LEAGUE_ID = 140; // 140 = Serie A (Italia) - Cambiar según la liga
const SEASON = 2021; // Temporada 2023
const FROM_DATE = "2021-01-01"; // Fecha de inicio de la temporada
const TO_DATE = "2021-12-31"; // Fecha de fin de la temporada
    ...
    try {
      ...
      const fixturesWithOdds = data.response.map((fixture: any) => {
        ...
        return {
          ...
          home_score: fixture.goals.home,  // Goles del equipo local
          away_score: fixture.goals.away,  // Goles del equipo visitante
